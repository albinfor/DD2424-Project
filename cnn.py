...
if __name__ == "__main__":
	...
	checkpoint = ModelCheckpoint("best_model_cnn.hdf5", monitor='val_loss', verbose=1,
								 save_best_only=True, mode='auto', period=1)

	# train the model
	model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=150, callbacks=[checkpoint], verbose=True)
	...
	pickle.dump(model, open("Pickles/latestmodelcnn.p", "wb"))